...
define AOM_AV1_PSY_BUILD_CMDS
	...
	(cd $(AOM_AV1_PSY_BUILDDIR);$(TARGET_MAKE_ENV) cmake $(@D) \
 	-G"Unix Makefiles" -DCMAKE_TOOLCHAIN_FILE="/home/maguoqun/workspace/build_root_bench/buildroot/output/host/share/buildroot/toolchainfile.cmake" \
...
define AOM_AV1_PSY_INSTALL_TARGET_CMDS
	...
	ln -s $(TARGET_DIR)/usr/lib/libaom.so.3.5.0 $(TARGET_DIR)/usr/lib/libaom.so.3
	ln -s $(TARGET_DIR)/usr/lib/libaom.so.3 $(TARGET_DIR)/usr/lib/libaom.so
